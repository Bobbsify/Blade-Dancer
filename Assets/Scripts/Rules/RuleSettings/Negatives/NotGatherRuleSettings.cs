...
public class NotGatherRuleSettings : RuleSetting
{
    ...
    public override Rule GetRule()
    {
        ...
        NotGatherRule returnedRule = new NotGatherRule(AllRules.NotRaccogli, ruleIcon, amountNotToGather, durationMod, appliedActions, mutuallyExclusives, ruleRelatedObjects);
        return returnedRule;
    }
}
