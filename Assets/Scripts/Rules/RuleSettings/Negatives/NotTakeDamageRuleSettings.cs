...
public class NotTakeDamageRuleSettings : RuleSetting
{
    ...
    {
        NotTakeDamageRule returnedRule = new NotTakeDamageRule(AllRules.NotDanneggiati, ruleIcon, durationMod, appliedActions, mutuallyExclusives, ruleRelatedObjects);
        return returnedRule;
    }
}
